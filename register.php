...
if (isset($_POST['register-submit'])) {
  ...
  if ($password !== $confirm_password) {
    ...
    $result = $fetch->request("POST", "/wp-json/custom/v1/register", [], $payload);

    if ($result['success']) {
        if (! is_null($result['response'])) {
            $user_id = json_decode($result['response'], true)['user_id'];
                ...
                <div class="col-lg-8 mx-auto">
                  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="username" name="username" placeholder="Full Name" required="" autocomplete="name">
                    ...
                    <div class="d-grid mb-4">
                      <button type="submit" name="register-submit" class="btn btn-register">Create Account</button>
                    </div>
