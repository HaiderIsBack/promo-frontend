...
if (! verify_user_token()) {
  header('Location: '. SITE_URL . '/login.php?redirect_url=' . urlencode(SITE_URL . '/checkout.php'));
  die();
}
...
if (count($_SESSION['cart']) < 1) {
  $_SESSION['toast'] = json_encode(['type' => 'info', 'message' => 'Your cart is empty!']);
        ...
        <div class="row">
          <div class="col-lg-7">
            ...
            <div class="checkout-container" data-aos="fade-up">
              <form class="checkout-form" method="POST" action="./forms/place_order.php">
                ...
                <div class="checkout-section" id="payment-method">
                  ...
                  <div class="section-content">
                    <div class="payment-options">
                      ...
                      $result = $fetch->request("GET", "/wp-json/wc/v3/payment_gateways");

                      if ($result['success']) {
                        if (! is_null($result['response'])) {
                            $payment_methods = json_decode($result['response'], true);
                            $payment_methods = array_filter($payment_methods, function ($m) { return $m['enabled'] === true; });
                        }
                      } else {
                        echo $result['message'];
                      }
                      ...
                      <div class="payment-option <?php echo $index === 0 ? 'active' : ''; ?>">
                        <input type="radio" name="payment-method[]" value="<?php echo $method['id'] . ':' . $method['title']; ?>" checked=''>
                        <label for="<?php echo $method['id']; ?>">
                          ...
                          <span class="payment-label"><?php echo $method['title']; ?></span>
                        </label>
                      </div>
                      <?php }} ?>
                    </div>
                ...
                <div class="checkout-section" id="order-review">
                  ...
                  <div class="section-content">
                    ...
                    <div class="place-order-container">
                      <button type="submit" name="confirm-order-placement" class="btn btn-primary place-order-btn">
                        <span class="btn-text">Place Order</span>
                        <span class="btn-price">Rs.<?php echo number_format($subtotal + $shipping + $tax); ?></span>
                      </button>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-lg-5">
            ...
            <div class="order-summary" data-aos="fade-left" data-aos-delay="200">
              <div class="order-summary-header">
                <h3>Order Summary</h3>
                <span class="item-count"><?php echo get_cart_count(); ?> Items</span>
              </div>
              ...
              <div class="order-summary-content">
                    ...
                    <div class="order-item">
                      ...
                      <div class="order-item-details">
                        ...
                        <div class="order-item-price">
                          <span class="quantity"><?php echo $product['cart_quantity']; ?> ×</span>
                          <span class="price"><?php echo $product['on_sale'] ? "Rs." . number_format($product['sale_price']) : "Rs." . number_format($product['price']); ?></span>
                        </div>
                      </div>
                    </div>
                  <?php endforeach; ?>
                ...
                <div class="order-totals">
                  ...
                  <div class="order-total d-flex justify-content-between">
                    <span>Total</span>
                    <span>Rs.<?php echo number_format($subtotal + $shipping + $tax); ?></span>
                  </div>
                </div>
